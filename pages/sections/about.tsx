...
export default function About() {
  return (
    <section className="flex flex-col w-full h-full my-8 md:my-12 max-h-[60rem] justify-center items-center">
      <div className="flex justfify-end items-end translate-x-18 left-20">

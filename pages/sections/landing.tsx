...
export default function Landing() {
  ...
  return (
    <>
      <section className="relative flex flex-col-reverse w-full h-screen md:min-h-[55rem]">
            ...
            router.pathname !== '/apply' && (
              <Link passHref href="/apply">
                <motion.button
                  ...
                  className="flex justify-center items-center self-center w-full md:max-w-[16rem] h-11 px-4 font-semibold text-lg rounded-md bg-red shadow cursor-pointer text-white bg-purple"
                >
                  Apply Now!
                </motion.button>
              </Link>

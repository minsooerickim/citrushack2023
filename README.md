...
- **[MongoDB](https://www.mongodb.com/)**: This is the primary database used for the backend for this project
- **[TailwindCSS](https://tailwindcss.com/)**: This is the CSS framework used for the frontend for this project
